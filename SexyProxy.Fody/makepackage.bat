...
..\packages\NugetUtilities.1.0.5\UpdateVersion.exe SexyProxy.Fody.nuspec -Increment

mkdir build
cd build

copy ..\SexyProxy.Fody.nuspec .
...
..\nuget pack SexyProxy.Fody.nuspec
